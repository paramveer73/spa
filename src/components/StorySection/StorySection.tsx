...
import { PORTRAITS, brand, stylist, home } from "@/data";
 ...
 */
const CHAPTERS = [
  { image: PORTRAITS.brows, kicker: brand.copy.story.chapters[0], body: home.about.body[0] },
  { image: PORTRAITS.lashes, kicker: brand.copy.story.chapters[1], body: home.about.body[1] },
  { image: PORTRAITS.studio, kicker: brand.copy.story.chapters[2], body: stylist.bio },
];
