...
export const BACKDROPS = {
  ...
  // Brow work in progress, so it complements the hero's before/after rather
  // than repeating it. The black gloves and hair give white type large dark
  // areas to sit on across the mosaic.
  services: wix("e42676_c8b722d9e0e146f18b59cea3718b02ef~mv2.jpg", 2400, 1600),
} as const;
